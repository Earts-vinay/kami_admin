...
const PairDevice = () => {
    ...
    // Sample data array
    const devices = [
        { id: 1, cameraView: 'assets/images/car1.png', ipAddress: '192.168.1.1', networkType: '4G', status: 'Authenticated', paired: true },
        { id: 2, cameraView: 'assets/images/car1.png', ipAddress: '192.168.1.2', networkType: 'WiFi', status: 'Not Authenticated', paired: false },
        ...
        <>
            <div style={{ display: 'flex' }}>
                ...
                <div style={{
                    ...
                    <Box padding="15px">
                    <Typography varient="h6"  >Pair a New Device</Typography>
